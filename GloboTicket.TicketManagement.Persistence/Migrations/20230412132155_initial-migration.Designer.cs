...
namespace GloboTicket.TicketManagement.Persistence.Migrations
{
    ...
    [Migration("20230412132155_initial-migration")]
            ...
            modelBuilder.Entity("GloboTicket.TicketManagement.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Artist = "John Egbert",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2023, 10, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5129),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2024, 1, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5162),
                        ...
                        new
                        {
                            ...
                            Artist = "DJ 'The Mike'",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2023, 8, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5216),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2023, 8, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5229),
                        ...
                        new
                        {
                            ...
                            Artist = "Many",
                            CategoryId = new Guid("fe98f549-e790-4e9f-aa16-18c2292a2ee9"),
                            Date = new DateTime(2024, 2, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5240),
                        ...
                        new
                        {
                            ...
                            Artist = "Nick Sailor",
                            CategoryId = new Guid("6313179f-7837-473a-a4d5-a5571b43e6a6"),
                            Date = new DateTime(2023, 12, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5251),
            ...
            modelBuilder.Entity("GloboTicket.TicketManagement.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 4, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5268),
                            OrderTotal = 400,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 4, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5280),
                            OrderTotal = 135,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 4, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5290),
                            OrderTotal = 85,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 4, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5300),
                            OrderTotal = 245,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 4, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5339),
                            OrderTotal = 142,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 4, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5351),
                            OrderTotal = 40,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2023, 4, 12, 16, 21, 55, 344, DateTimeKind.Local).AddTicks(5361),
                            OrderTotal = 116,
                            UserId = new Guid("7aeb2c01-fe8e-4b84-a5ba-330bdf950f5c")
                        });
                });
